...
Text fields for Long-Term, Immediate, Signature, and Peripheral Mage Sight nimbus descriptions. An "Affected Stats" grid lets you assign a -10 to +10 modifier to each of the nine attributes.
